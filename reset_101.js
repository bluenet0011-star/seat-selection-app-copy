...
async function ensureUser() {
    try {
        const id = "101";
        const email = "101@school.com";

        try {
            await auth.getUser(id);
            await auth.updateUser(id, { password: "password123" });
            console.log("User 101 password reset");
        } catch (e) {
            ...
            console.log("User 101 created with password123");
        }
    } catch (e) {
